...
public class Menu extends JPanel implements ActionListener,KeyListener {
    ...
    Menu() throws UnsupportedAudioFileException, IOException
    {
                try {
                    ...
                    playButton.setIcon(new ImageIcon("C:\\Users\\Fatine\\Desktop\\EcamusGame\\EcamusGame\\Image\\Vulcania.jpg"));/* Bien entrer le bon chemin d'acces de l'image */
                    playButton.addActionListener(this);
                    playButton.addKeyListener(this);
                    window.add(playButton,BorderLayout.PAGE_START);
                    exitButton.setBackground(Color.DARK_GRAY);
                    exitButton.setIcon(new ImageIcon("C:\\Users\\Fatine\\Desktop\\EcamusGame\\EcamusGame\\Image\\Exit_Button.png"));/* Bien entrer le bon chemin d'acces de l'image */
                    exitButton.addActionListener(this);
                    exitButton.addKeyListener(this);
                    window.add(exitButton,BorderLayout.PAGE_END);
                    background.setIcon(new ImageIcon("C:\\Users\\Fatine\\Desktop\\EcamusGame\\EcamusGame\\Image\\Gladiador.jpg"));/* Bien entrer le bon chemin d'acces de l'image */
